            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              {!isLogin && (
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 rounded-xl border border-slate-200 bg-white/50 focus:bg-white focus:ring-2 focus:ring-indigo-200 outline-none transition-all"
              ...
              {!isLogin && (
                <div className="flex items-start space-x-2 mt-4">
                  <input type="checkbox" className="mt-1 rounded border-slate-300 text-indigo-600 focus:ring-indigo-200" required />
              ...
              <Button type="submit" className="w-full mt-2" size="lg" disabled={loading}>
                {loading ? 'Processing...' : (isLogin ? 'Enter Dashboard' : 'Start Analytics Journey')}
              </Button>
            </form>
