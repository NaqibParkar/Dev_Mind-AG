    ...
    <div className="flex h-screen overflow-hidden bg-gradient-to-br from-blue-100 via-indigo-100 to-cyan-100 relative">
      ...
      <aside className="w-64 flex-shrink-0 border-r border-white/40 bg-white/30 backdrop-blur-xl flex flex-col relative z-20 shadow-sm">
        ...
        <nav className="flex-1 px-4 py-4 space-y-1 overflow-y-auto">
          <NavItem page="dashboard" icon={Icons.LayoutDashboard} label="Overview" activePage={activePage} onNavigate={onNavigate} />
          <NavItem page="live-detection" icon={Icons.Activity} label="Live Detection" activePage={activePage} onNavigate={onNavigate} />
          <NavItem page="analytics" icon={Icons.BarChart2} label="Analytics" activePage={activePage} onNavigate={onNavigate} />
          <NavItem page="projects" icon={Icons.FolderKanban} label="Projects" activePage={activePage} onNavigate={onNavigate} />
          <NavItem page="settings" icon={Icons.Settings} label="Settings" activePage={activePage} onNavigate={onNavigate} />
        </nav>
