...
def get_dashboard_stats(db: Session):
    ...
    # Average focus score
    avg_focus = sum(log.focus_score or 0 for log in logs) / total_logs
    ...
    avg_cog = sum(log.cognitive_load or 0 for log in logs) / total_logs
    ...
    deep_count = sum(1 for log in logs if log.mental_state in deep_states)
...
def get_analytics_data(db: Session, project_id: str | None = None, granularity: str = 'hourly'):
    """
